  ...
  return (
    ...
    >
      <div className="card-images relative flex justify-center mb-6">
        ...
        <img src={product.image} alt="Product image" className="h-[200px] transition-all hover:scale-105" />
        <div
          className="favorite absolute heart top-0 -right-5 z-20 hover:scale-105 hover:opacity-70 w-8 h-8"
          id={product.id}
  ...
  return (
    ...
    >
      <div className="card-images relative flex justify-center mb-6">
        ...
        <img src={product?.image} alt="Product image" className="h-[65px]  transition-all hover:scale-105" />
        <img src={product?.image} alt="Product image" className="h-[65px] transition-all hover:scale-105" />
        <img src={product?.image} alt="Product image" className="h-[65px] transition-all hover:scale-105" />
        </span>
        <img src={product.image} alt="Product image" className="h-[200px] transition-all hover:scale-105" />
