    ...
    return (
      <>
        ...
        <div className="basket flex flex-col items-center justify-center min-h-[60vh] gap-y-6">
          ...
          <h2 className="font-semibold text-[18px] leading-6 text-[#1C1C27]">
            Your basket is free!!!
          </h2>
          <Link
            to="/"
            className="bg-[#101010] w-60 shadow rounded-[15px] flex items-center justify-center py-3 font-semibold text-[15px] leading-6 text-white"
          >
            Go home
          </Link>
        </div>
          ...
          <div className="basket-section__inner  grid gap-y-6 justify-center gap-x-6 md:grid-cols-2">
            ...
            <div className="action max-w-[360px] bg-white pt-6 rounded-[30px] shadow-xl  h-fit">
              <div className="text flex justify-between ites-center px-5">
                <h2 className="font-semibold text-[15px] leading-[18px]">
                  All price
                </h2>
                <p className="font-semibold text-[15px] leading-[18px]">
                  {Math.round(basketCartTotalAmount) + 499} $
                </p>
              </div>
              <Link
                to="/ordering"
