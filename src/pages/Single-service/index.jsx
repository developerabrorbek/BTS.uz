...
import { SingleProductCard } from "../../components/Cards";
          ...
          <div className="product__inner grid gap-y-6 md:grid-cols-2 gap-x-4">
            ...
            <div className="description rounded-[15px] overflow-hidden">
              ...
              <div className="actions mt-6">
                <Link
                  to={`/service-ordering/${id}`}
                  className="bg-[#25e05d] block shadow rounded-[10px] text-white text-center py-[13px] w-[255px]"
                >
                  Order service!
                </Link>
              </div>
